...
fn bench_submit_attestation_no_fee() {
    ...
    client.submit_attestation(&business, &period, &root, &1_700_000_000u64, &1u32, &0i128, &None, &None, &0u64);
...
fn bench_migrate_attestation() {
    ...
    client.submit_attestation(&business, &period, &old_root, &1_700_000_000u64, &1u32, &0i128, &None, &None, &0u64);
...
fn migration_does_not_accumulate() {
    ...
    client.submit_attestation(&business, &period, &root1, &1_700_000_000u64, &1u32, &0i128, &None, &None, &0u64);
